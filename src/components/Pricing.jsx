          ...
          {PLANS.map(
            ({ name, price, period, tagline, features, highlighted }) => (
              ...
              >
                ...
                {/* Tagline + name */}
                <p
                  className="font-poppins text-[11px] md:text-[10px] tracking-[0.18em] uppercase mb-2 md:mt-2"
                  style={{
                    color: highlighted
                      ? "rgba(250,250,239,0.52)"
                      : "rgba(59,59,59,0.45)",
                  }}
                >
                  {tagline}
                ...
                <h3
                  className="font-oswald font-bold text-3xl md:text-2xl uppercase tracking-wide mb-4"
                ...
                {/* Features */}
                <ul className="flex flex-col gap-3 flex-1 mb-8 md:mb-2">
                  {features.map((f) => (
                    <li key={f} className="flex items-start gap-2.5">
                      <CheckCircle2
                        ...
                        style={{
                          color: highlighted
                            ? "rgba(250,250,239,0.75)"
                            : "#3B3B3B",
                        }}
                      />
                      <span
                        className="font-poppins text-sm md:text-[10px]"
                        style={{
                          color: highlighted
                            ? "rgba(250,250,239,0.7)"
                            : "rgba(59,59,59,0.68)",
                        }}
                      >
                        {f}
