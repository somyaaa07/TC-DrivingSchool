...
const STEPS = [
  {
    ...
    title: "Book Online",
    description:
      "Pick your course and preferred time slot through our quick booking form. Instant confirmation, zero hassle.",
  },
  {
    num: "02",
    Icon: BookOpen,
    title: "Orientation",
    description:
      "A one-hour induction covering vehicle familiarisation, road code, and your personalised training plan.",
  },
  {
    num: "03",
    Icon: Navigation,
    ...
    description:
      "Progress through structured on-road sessions with your dedicated RTO-certified instructor.",
  },
  {
    num: "04",
    Icon: Trophy,
    title: "Test & Licence",
    description:
      "We prepare you fully for the RTO test and accompany you on test day for maximum confidence.",
  },
];
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2
            className="font-oswald font-bold uppercase  mb-6 leading-tight"
            style={{
